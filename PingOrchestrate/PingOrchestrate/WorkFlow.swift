...
public class Workflow {
    ...
    internal var nextHandlers = [(FlowContext, NextNode, Request) async throws -> Request]()
    ...
    /// - Parameters:
    ///   - context: The context of the flow.
    ///   - current: The current NextNode.
    /// - Returns: The resulting Node after processing the next step.
    public func next(_ context: FlowContext, _ current: NextNode) async -> Node {
        do {
